...
const form=document.getElementById("myElement");
...
const startTimer = () => {
    ...
    const countDown = ()=>{
        ...
        timer.textContent = timeLeft;
        if(timeLeft === 0){
            const confirmUser = confirm("oops!Time out.. Wanna play the quiz again");
            if(confirmUser){
                timeLeft = 15;
                startQuiz();
            }
...
var outputElement=document.getElementById("myElement")
outputElement.innerHTML="Hello, " + newname + "!";